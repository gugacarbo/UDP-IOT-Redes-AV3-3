...
>  Gostaria de uma solução que nos permitisse monitorá-los, desligá-los e ligálos tudo remotamente...”
...
| Tipo         | Acesso          | Luz     | AC     |
| ------------ | --------------- | ------- | ------ |
| `sensor_*`   | Somente leitura | boolean | 0–1023 |
| `actuator_*` | Leitura/escrita | boolean | 0–1023 |
